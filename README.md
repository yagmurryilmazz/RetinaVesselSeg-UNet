...
Genelleme Yeteneği: Veri artırma (Augmentation) teknikleri sayesinde modelin farklı fundus kameralarından gelen görüntülere karşı gürbüz (robust) bir performans sergilemesini sağladım. Modelim %96+ doğruluk oranına ulaşmıştır.

📂 Klasör Yapısı
Plaintext

├── DRIVE/                  # Orijinal Veri Seti (Görüntüler ve Maskeler)
│   ├── training/           # Eğitim verileri (images/ ve 1st_manual/)
│   └── test/               # Test verileri
├── Modeller/               # Eğitilmiş .keras modelleri
├── main.ipynb              # Ana kod dosyası (Eğitim ve Tahmin)
└── README.md               # Proje dokümantasyonu
🛠️ Kurulum ve Veri Seti
Veri Setini İndir: Bu projede kullanılan DRIVE veri setine buradan (Kaggle) ulaşabilirsiniz.

Gereksinimler: Python 3.x, TensorFlow, OpenCV, NumPy ve Matplotlib kütüphanelerinin yüklü olduğundan emin olun.

Çalıştırma: main.ipynb dosyasını çalıştırarak eğitimi başlatabilir veya kayıtlı modeli kullanarak yeni görüntüler üzerinde tahmin yapabilirsiniz.
...
Generalization Ability: Used Data Augmentation techniques to ensure robust performance across images from different fundus cameras. The model achieved an accuracy of 96%+.
...
├── main.ipynb              # Main notebook for training and inference
└── README.md               # Documentation
🛠️ Installation and Dataset
Download Dataset: You can access the DRIVE dataset used in this project here (Kaggle).

Requirements: Ensure Python 3.x, TensorFlow, OpenCV, NumPy, and Matplotlib are installed.

Execution: Run the cells in main.ipynb to start training or use the saved model for inference on new images.

📜 Citation / Atıf: If you use this work in your research or project, please support it by giving a star ⭐. / Eğer bu çalışmayı projelerinizde veya araştırmalarınızda kullanacaksanız, lütfen star ⭐ vererek desteklemeyi unutmayın
